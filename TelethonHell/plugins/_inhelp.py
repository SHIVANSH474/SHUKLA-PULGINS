    ...
    async def inline_handler(event):
        ...
        if event.query.user_id in auth and query == "hellbot_help":
            ...
            if a:
                ...
                help_pic = "https://graph.org/file/c6a2ed96648fd03377dc9.jpg"
            ...
            if help_pic == "DISABLE":
                ...
                result = builder.document(
                    help_pic,
                    text=help_msg,
                    title="⚡️𝐒ᴛʀᴀɴɢᴇʀ 𝐀ʟɪᴠᴇ⚡️",
                    buttons=veriler[1],
                    link_preview=False,
                )
        elif event.query.user_id in auth and query == "alive":
            uptime = await get_time((time.time() - StartTime))
            alive_msg = gvarstat("ALIVE_MSG") or "»»» <b>⚡️𝐒ᴛʀᴀɴɢᴇʀ 𝐈s 𝐎ɴʟɪɴᴇ⚡️</b> «««"
            ...
            alv_btn = [
                ...
                [
                    Button.url("⚡️𝗖𝗛𝗔𝗡𝗡𝗘𝗟⚡️", f"https://t.me/SHIVANSH474"),
                    Button.url("⚡️𝗦𝗨𝗣𝗣𝗢𝗥𝗧⚡️", f"https://t.me/mastiwithfriendsx"),
                ],
            ]
            ...
            result = builder.article(
                ...
                text=f"**⚡️𝐒𝐓𝐑𝐀𝐍𝐆𝐄𝐑⚡️**",
                buttons=[
                    [Button.url("⚡️ 𝐑ᴇᴘᴏ ⚡️", "https://github.com/itzshukla/STRANGER-HELLBOT")],
                    [Button.url("⚡️𝐒ᴛʀᴀɴɢᴇʀ 𝐍ᴇᴛᴡᴏʀᴋ⚡️", "https://t.me/SHIVANSH474")],
                ],
            )
            ...
            result = builder.article(
                "@SHIVANSH474",
                text="""**Hey! This is [⚡️𝐒ᴛʀᴀɴɢᴇʀ⚡️](https://t.me/SHIVANSH474) \nYou can know more about me from the links given below 👇**""",
                buttons=[
                    [
